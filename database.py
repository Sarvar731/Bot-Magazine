...
def insert_products_table():
    ...
    cursor.execute('''
        ...
        (1, 'Лаваш говяжий', 28000, 'Мясо, огурчики, чипсы, помидоры', 'media/lavash/Lavash_1.jpg'),
        (1, 'Лаваш куриный', 26000, 'Мясо куриное, огурчики, чипсы, помидоры', 'media/lavash/lavash_2.jpg'),
        (1, 'Лаваш говяжий с сыром', 30000, 'Мясо, огурчики, чипсы, помидоры, сыр', 'media/Lavash/Lavash_1.jpg')
    ''')
    database.commit()
    database.close()
